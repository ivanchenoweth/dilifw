...
var MonthName=["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio","Julio", 
	"Augosto", "Septiebere", "Octubre", "Noviembre", "Diciembre"];
var WeekDayName1=["Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sabado"];
var WeekDayName2=["Lunes","Martes","Miercoles","Jueves","Viernes","Sábado","Domingo"];
...
var WindowTitle ="Hora y Fecha";//Date Time Picker title.
...
function NewCal(pCtrl,pFormat,pShowTime,pTimeMode,pScroller,pHideSeconds)
{
	...
	winCal=window.open("","FechaHora","toolbar=0,status=0,menubar=0,fullscreen=no,width=200,height=245,resizable=0,top="+cnTop+",left="+cnLeft);
	RenderCal();
	winCal.focus();
}
